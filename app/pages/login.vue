...
<template>
  ...
  <div class="flex flex-col gap-6 min-h-screen items-center justify-center bg-gray-50 dark:bg-gray-900">
    ...
    <UCard class="w-full max-w-md p-6">
      ...
      <UForm @submit.prevent="login" :schema="schema" :state="credentials" class="space-y-6">
        ...
        <UButton type="submit" color="primary" block :loading="loading" class="hover:cursor-pointer">
          {{ $t('login') }}
        </UButton>
